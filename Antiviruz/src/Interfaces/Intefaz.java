...
public class Intefaz extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txt_m.setBackground(new java.awt.Color(255, 255, 255));
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(txt_m, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btn_analizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_analizarActionPerformed
        ...
        String aDirectorio = "AppData\\Local\\Temp";
        File f_1= new File(aDirectorio);
        String Directorio = f_1.getAbsolutePath();
        JOptionPane.showMessageDialog(null, Directorio);
        File f_2= new File(Directorio);
        
        if (f_2.exists()){ JOptionPane.showMessageDialog(null, "existe carpeta %Temp%"); }
        else { JOptionPane.showMessageDialog(null, "nO existe carpeta %Temp%"); }
        
        
        File[] ficheros_1 = f_2.listFiles();
         JOptionPane.showMessageDialog(null, ficheros_1.length);
     
        File f = new File(sDirectorio);
        if (f.exists()){ JOptionPane.showMessageDialog(null, "existe carpeta Temp"); }
        else { JOptionPane.showMessageDialog(null, "nO existe carpeta Temp"); }
        File[] ficheros = f.listFiles();
                txt_arch.setText("Tienes un total de: "+(ficheros_1.length+ficheros.length)+" basuras\n\n\n\nEn la carpeta Temp tienes: "+ficheros.length+"\nEn la carpeta %Temp% tienes: "+ficheros_1.length);
